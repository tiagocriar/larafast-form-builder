...
class FormBuilder
{
     ...
     *
     * @param string $formClass The name of the class that inherits \Fastponto\LaravelFormBuilder\Form.
     ...
     * @param array $options
     * @param array $data
     * @return \Fastponto\LaravelFormBuilder\Form
     */
     ...
     *
     * @param \Fastponto\LaravelFormBuilder\Form $instance
     * @param array $options
     * @param array $data
     * @return \Fastponto\LaravelFormBuilder\Form
     */
