...
namespace Fastponto\LaravelFormBuilder;
...
class FormBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Fastponto\LaravelFormBuilder\Console\FormMakeCommand');
        ...
        $this->app->alias('laravel-form-builder', 'Fastponto\LaravelFormBuilder\FormBuilder');
    ...
    protected function registerFormHelper()
    {
        ...
        $this->app->alias('laravel-form-helper', 'Fastponto\LaravelFormBuilder\FormHelper');
    }
