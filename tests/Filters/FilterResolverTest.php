...
use \Fastponto\LaravelFormBuilder\Filters\Collection\Trim;
...
class FilterResolverTest extends FormBuilderTestCase
{
    ...
    {
        $expected = \Fastponto\LaravelFormBuilder\Filters\FilterInterface::class;
    ...
    {
        $this->expectException(\Fastponto\LaravelFormBuilder\Filters\Exception\InvalidInstanceException::class);
    ...
    {
        $this->expectException(\Fastponto\LaravelFormBuilder\Filters\Exception\UnableToResolveFilterException::class);
